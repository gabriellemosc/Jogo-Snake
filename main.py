...
largura, altura = 1200, 700 #largura tela

tela =  pygame.display.set_mode((largura, altura)) #Passar o parametro
...
#Lógica de terminar o jogo
  #o que acontece:
  #cobra bateu na parede
  #cobra bateu na própria cobra

#Pegar as interaçoes do usuário
 #Fechou o jogo 
 #apertou as teclas para mover o jogo
